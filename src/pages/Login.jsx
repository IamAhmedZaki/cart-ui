...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-orange-400 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full space-y-8 bg-gray-50 p-10 rounded-2xl">
        ...
        <div className="mt-10 text-center">
          <button className="w-full py-3 px-4 border-2 border-yellow-500 rounded-md text-yellow-600 font-bold hover:bg-yellow-50"
